    ...
    if (!_showByFading) {
        ...
        [UIView animateWithDuration:duration + 0.1 animations:^{
            ...
            if (_photo.srcImageView) {
                ...
                _imageView.alpha = 0.0;
                CGFloat h = _imageView.frame.size.height/2;
                CGFloat w = _imageView.frame.size.width/2;
                
                _imageView.frame = CGRectMake(_imageView.frame.origin.x-h, _imageView.frame.origin.y-w,_imageView.frame.size.width*2, _imageView.frame.size.height*2);
                //[_photo.srcImageView convertRect:_photo.srcImageView.bounds toView:nil];
            }
