...
//  wyw
//
//  Created by Xiaoshiheng_pro on 2017/2/25.
...
@implementation XSHPlayerToolView
- (instancetype)init{
    self = [super init];
    if (self) {
...
- (UIButton *)backBtn
{
    if (!_backBtn) {
        ...
        [_backBtn setImage:[UIImage imageNamed:XSHPlayerSrcName(@"XSHPlayer_back_full")] forState:UIControlStateNormal];
    }
    return _backBtn;
}
...
- (UIImageView *)topImageView
{
    if (!_topImageView) {
        ...
        _topImageView.image                  = [UIImage imageNamed:XSHPlayerSrcName(@"XSHPlayer_top_shadow")];
    }
...
- (UIImageView *)bottomImageView
{
    if (!_bottomImageView) {
        ...
        _bottomImageView.image                  = [UIImage imageNamed:XSHPlayerSrcName(@"XSHPlayer_bottom_shadow")];
    }
...
- (UIButton *)startBtn
{
    if (!_startBtn) {
        ...
        [_startBtn setImage:[UIImage imageNamed:XSHPlayerSrcName(@"XSHPlayer_play")] forState:UIControlStateNormal];
        [_startBtn setImage:[UIImage imageNamed:XSHPlayerSrcName(@"XSHPlayer_pause")] forState:UIControlStateSelected];
    }
    return _startBtn;
}
...
- (UISlider *)videoSlider
{
    if (!_videoSlider) {
        ...
        // 设置slider
        [_videoSlider setThumbImage:[UIImage imageNamed:XSHPlayerSrcName(@"XSHPlayer_slider")] forState:UIControlStateNormal];
...
- (UIButton *)fullScreenBtn
{
    if (!_fullScreenBtn) {
        ...
        [_fullScreenBtn setImage:[UIImage imageNamed:XSHPlayerSrcName(@"XSHPlayer_fullscreen")] forState:UIControlStateNormal];
        [_fullScreenBtn setImage:[UIImage imageNamed:XSHPlayerSrcName(@"XSHPlayer_shrinkscreen")] forState:UIControlStateSelected];
    }
...
- (UILabel *)horizontalLabel
{
    if (!_horizontalLabel) {
        ...
        //_horizontalLabel.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:XSHPlayerSrcName(@"XSHPlayer_management_mask")]];
    }
...
- (UIButton *)repeatBtn
{
    if (!_repeatBtn) {
        ...
        [_repeatBtn setImage:[UIImage imageNamed:XSHPlayerSrcName(@"XSHPlayer_repeat_video")] forState:UIControlStateNormal];
    }
    return _repeatBtn;
}
...
- (UIButton *)playeBtn{
    if (!_playeBtn) {
        ...
        [_playeBtn setImage:[UIImage imageNamed:XSHPlayerSrcName(@"XSHPlayer_play_btn")] forState:UIControlStateNormal];
    }
    return _playeBtn;
}
